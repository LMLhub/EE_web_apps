...
def main():
    ...
    N = 2
    T = 2500
    c = st.slider('Loss fraction:', value=0.95, min_value=0.00, max_value=1.00, step=0.01)
    p = st.slider('Loss probability:', value=0.05, min_value=0.00, max_value=1.00, step=0.01)
    t = np.arange(0,T)
